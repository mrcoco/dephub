    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="ii">
            ...
            <ul class="nav nav-tabs" id="myTab2">
                <li class="active"><a href="#ii1" data-toggle="tab">Pendidikan</a></li>
        ...
        <div class="tab-pane" id="iii">
            ...
            <ul class="nav nav-tabs" id="myTab3">
                <li class="active"><a href="#iii1" data-toggle="tab">Riwayat Kepangkatan</a></li>
                <li><a href="#iii2" data-toggle="tab">Pengalaman Jabatan</a></li>
            </ul>

            <div class="tab-content">
                <div class="tab-pane active" id="iii1">
                    <table class="table table-condensed table-striped table-bordered">
                        <tr>
                            <th colspan="6" align="center">Diklat jabatan / penjenjangan</th>
                        </tr>
        ...
        <div class="tab-pane" id="vi">
            ...
            <ul class="nav nav-tabs" id="myTab4">
                <li class="active"><a href="#vi1" data-toggle="tab">Istri / Suami</a></li>
        ...
        <div class="tab-pane" id="vii">
            <ul class="nav nav-tabs" id="myTab5">
                <li class="active"><a href="#vii1" data-toggle="tab">Site ke bawah</a></li>
