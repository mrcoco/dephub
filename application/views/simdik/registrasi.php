<script>
    ...
    $(document).ready(function(){        
        ...
        $('#instansi').focus(function(){
            $.getJSON('<?php echo base_url() ?>site/dashboard/list_instansi',function(result){
                option=result;
        ...
        $('#instansi').change(function(){
            ...
            $.get('<?php echo base_url() ?>site/dashboard/get_kode_instansi/'+$('#instansi').val(),function(result){
                kode_kantor=result;
//                console.log(kode_kantor);
    ...
    function tes(num){
        if(kode_kantor>0){
            console.log(kode_kantor);
            $.getJSON('<?php echo base_url() ?>site/dashboard/get_cv_peserta/'+kode_kantor,function(result){
                option=result;
    ...
    function tes2(num){
        nip=$('#nip'+num).val();
        $.getJSON('<?php echo base_url() ?>site/dashboard/get_data_peserta/'+nip,function(result){
    ...
    function view_history(num){
        if($('#nip'+num).val()==''){
            ...
            $.get("<?php echo base_url() ?>site/dashboard/get_history_pelatihan/"+num,function(result){
    ...
    function view_detail(num){
        if($('#nip'+num).val()==''){
            ...
            $.get("<?php echo base_url() ?>site/dashboard/get_detail_peserta/"+num,function(result){
                $('#display_dialog').html(result);
                $('#display_dialog').modal('show');
            })
        }
...
<form name="form_reg" id="form_reg" action="site/dashboard/registrasi_proses" method="POST">
