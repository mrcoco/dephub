...
<div class="well sidemenu">
    <ul class="nav nav-list">
        ...
        <li <?php if($t=='feedback_result_pem')echo 'class="active"' ?>><a href="<?php echo base_url()?>program/feedback_result_pem/<?php echo $program['id']?>"><i class="icon icon-chevron-right"></i> Rekap Evaluasi Pengajar</a></li>
        <?php } ?>
