...
<div class="well sidemenu">
    <ul class="nav nav-list">
        ...
        <li <?php if($t=='edit_program')echo 'class="active"' ?>><a href="<?php echo base_url()?>program/edit_program/<?php echo $program['id']?>"><i class="icon icon-chevron-right"></i> Ubah Program</a></li>
        <?php } ?>
        ...
        <?php } ?>
        <li><a href="#"><i class="icon icon-chevron-right"></i> Daftar Peserta</a></li>
    </ul>
</div>
