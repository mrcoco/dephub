...
<div class="well sidemenu">
    <ul class="nav nav-list">
        ...
        <li <?php if($t=='edit_diklat')echo 'class="active"' ?>><a href="<?php echo base_url()?>diklat/edit_diklat/<?php echo $program['id']?>"><i class="icon icon-chevron-right"></i> Ubah Diklat</a></li>
