			...
			<table class="table table-condensed table-striped">
				...
				<tr><td>Judul</td><td> : <?php echo $bibliography[0]['title'];?> </td></tr>
				<tr><td>Pengarang</td><td> : <?php echo $bibliography[0]['authorname']; ?>          </td></tr>
                                ...
                                <tr><td>Tags</td><td> : <?php echo $bibliography[0]['tags'];?>  </td></tr>

                                <tr><td>Tags adalah keyword dari file tersebut</td></tr>
                                
			</table>
                         <a class="btn" href="<?php echo $bibliography[0]['location'];?>">Buka File</a>
