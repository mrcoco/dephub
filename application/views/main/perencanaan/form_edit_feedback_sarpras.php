...
<form id="form1" action="perencanaan/dashboard/update_feedback_sarpras" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="manfaat">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="5"><textarea name="manfaat"  class="input-xxlarge" rows="3"><?php echo $manfaat ?></textarea></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>&nbsp</td>
                            <td>Kelebihan</td>
                            <td colspan="3"><textarea name="kelebihan_catering"  class="input-xxlarge" rows="2"><?php echo $kelebihan_catering ?></textarea></td>
                        </tr>
                        <tr>
                            <td>&nbsp</td>
                            <td>Kekurangan</td>
                            <td colspan="3"><textarea name="kekurangan_catering"  class="input-xxlarge" rows="2"><?php echo $kekurangan_catering ?></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">Keterangan</td>
                            <td colspan="3"><textarea name="keterangan"  class="input-xxlarge" rows="2"><?php echo $keterangan ?></textarea></td>
                        </tr>
                    </tbody>
                </table>
            </div>
