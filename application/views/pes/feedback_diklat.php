...
<div class="well-small">
    <a href="perencanaan/feedback/edit_feedback_diklat/<?php echo $program['id'] ?>" class="btn"><i class="icon-edit"></i>Ubah</a>
    <a href="perencanaan/feedback/delete_feedback_diklat/<?php echo $program['id'] ?>" class="btn btn-danger"
