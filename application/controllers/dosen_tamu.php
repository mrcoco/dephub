...
class Dosen_tamu extends CI_Controller{
    ...
    function list_dosen(){
        ...
        $this->template->display('dosen_tamu/list_dosen',$data);
    }
    ...
    function detail_dosen($id){
        ...
        $this->template->display('dosen_tamu/detail_dosen',$data);
    }
    ...
    function add_dosen(){
        ...
        $data['kategori']=array(
            ...
            1=>'PNS');
        $data['pil_pangkat']=$this->rnc->get_pangkat_gol();
        $this->template->display('dosen_tamu/cv_dosen',$data);
    }
    ...
    function insert_dosen(){
        ...
        redirect(base_url().'dosen_tamu/list_dosen');
    }
    ...
    function edit_dosen($id){
        ...
        $this->template->display('dosen_tamu/edit_dosen',$data);
    }
    ...
    function edit_process(){
        ...
        redirect(base_url().'dosen_tamu/detail_dosen/'.$clause);
    }
