...
//=======
    ...
    function do_upload() {
        ...
        if (!$this->upload->do_upload()) {
            ...
            $this->template->display_lib('elibrary/digital/upload_form', $error);
        } else {
            ...
            if ($temp == '.pdf' || $temp = '.doc' || $temp = '.docx' || $temp = '.txt' || $temp = '.xls' || $temp = '.xlsx')
                $data['insert']['type'] = 1; //dokumen
            else if ($temp == '.mp4' || $temp = '.mp3' || $temp = '.wmv' || $temp = '.flv' || $temp = '.3gp' || $temp = '.mkv' || $temp = '.avi')
                $data['insert']['type'] = 2; //video
            else if ($temp == '.pptx' || $temp = '.ppt')
                $data['insert']['type'] = 3; //presentasi
            else
                $data['insert']['type'] = 0; //lain2
