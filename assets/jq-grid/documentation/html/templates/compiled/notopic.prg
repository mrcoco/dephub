...
Response.Write([]+ CRLF +;
   [<p>]+ CRLF +;
   [<img src="bmp/project.gif" /> &nbsp;<b><a ] + ;
 [href="vfps://NOOPENPROJECT/IMPORTCHM">Import from Html Help file or Html Help ] + ;
 [Workshop Project</a></b>]+ CRLF +;
   [<br/>]+ CRLF +;
 ...
 [for application and component documentation.]+ CRLF +;
   [<p>] + CRLF )
Response.Write([<img src="bmp/classheader.gif" border="0" align="left"> &nbsp;<b><a ] + ;
